...
class ContributionNumberedCanvas:
    ...
    def draw_footer(self):
        ...
        # Draw footer text - FIXED: Use drawString instead of drawCentredText
    ...
    def draw_header(self):
        ...
        if self.canvas._pageNumber > 1:
            ...
            # Header text - FIXED: Use drawString instead of drawCentredText
            self.canvas.setFillColor(colors.black)

            # Main header
            header_main = f"MCHANGO HUB CONTRIBUTION SUMMARY - {self.contribution_name}"
            ...
            # Sub header
            header_sub = f"Period: {self.period_start.strftime('%Y-%m-%d')} to {self.period_end.strftime('%Y-%m-%d')}"
