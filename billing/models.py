...
class WalletAccount(BaseModel):
	...
	@transaction.atomic
	def initiate_topup(self, amount, reference, charge , description="TopUp - Pending"):
		"""
	...
	@transaction.atomic
	def initiate_payment(self, amount, reference, charge, description="Payment - Pending"):
		"""
